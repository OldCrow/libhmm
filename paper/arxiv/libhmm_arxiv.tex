...
\TODO{Regenerate GHMM and HMMLib comparison data.
Hardware: Windows Ryzen~9 (AVX-512), compilers MSVC/MinGW/ClangCL.
Measure: forward-backward throughput (observations/s) vs.\ K (2--16 states),
T=1000, 100 sequences, discrete emissions.
Include GHMM comparison even if GHMM wins on raw throughput ---
the honest result strengthens the architectural discussion.}

\PLACEHOLDER{Figure: throughput vs.\ K for libhmm, HMMLib, GHMM, three compilers.}
...
S\&P 500       & 5,786 obs., 3 states  & \PLACEHOLDER{} & --- & --- \\
\bottomrule
\end{tabular}
\end{table}

\paragraph{Hardware note.}
\texttt{libhmm} timings were measured on a Windows system with a Ryzen~9
...
\PLACEHOLDER{Full parameter table to be added.}
