...
void benchmarkLibhmm() {
    ...
    std::cout << std::setw(15) << "Configuration" << std::setw(20) << "Forward-Backward (ms)"
              << std::setw(15) << "Viterbi (ms)" << std::setw(15) << "Likelihood" << std::endl;
    ...
    for (const auto &config : configs) {
        ...
        try {
            ...
            std::cout << std::setw(15)
                      << (std::to_string(num_states) + "x" + std::to_string(alphabet_size) + "x" +
                      ...
                      << std::setw(15) << std::scientific << std::setprecision(2) << likelihood
                      << std::endl;

        } catch (const std::exception &e) {
            std::cout << "Error with configuration " << num_states << "x" << alphabet_size << "x"
                      << seq_length << ": " << e.what() << std::endl;
        }
    }
}
...
void benchmarkDistributions() {
    ...
    std::cout << std::setw(25) << "Distribution" << std::setw(20) << "Time per 100k evals (ms)"
    ...
    for (size_t i = 0; i < distributions.size(); ++i) {
        ...
        std::cout << std::setw(25) << names[i] << std::setw(20) << std::fixed
...
void benchmarkTraining() {
    ...
    std::cout << std::setw(20) << "Configuration" << std::setw(20) << "Viterbi Training (ms)"
