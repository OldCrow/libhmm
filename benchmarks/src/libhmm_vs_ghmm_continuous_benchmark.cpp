...
BenchmarkResult runGhmmGaussian(const ContinuousGaussianProblems::GaussianSignalModel &model,
    ...
    try {
        ...
        int result_code =
            ghmm_cmodel_logp(ghmm_model, obs_array, observations.size(), &forward_likelihood);
        auto end = chrono::high_resolution_clock::now();
        ...
        start = chrono::high_resolution_clock::now();
        int *viterbi_path =
            ghmm_cmodel_viterbi(ghmm_model, obs_array, observations.size(), &viterbi_logp);
        end = chrono::high_resolution_clock::now();
        ...
        cout << "  GHMM - Forward: " << fixed << setprecision(3) << result.forward_time_ms
             << "ms, Viterbi: " << result.viterbi_time_ms << "ms\n";
        cout << "  GHMM - Log-likelihood: " << scientific << setprecision(3)
             << result.log_likelihood << "\n";
...
void analyzeNumericalAccuracy(const vector<BenchmarkResult> &results) {
    ...
    cout << left << setw(25) << "Problem" << setw(10) << "Length" << setw(18) << "libhmm LogLik"
         << setw(18) << "GHMM LogLik" << setw(18) << "Difference" << endl;
    cout << "--------------------------------------------------------------------------------\n";
...
int main() {
    ...
    cout << left << setw(25) << "Problem" << setw(10) << "Length" << setw(15) << "libhmm (ms)"
         << setw(15) << "GHMM (ms)" << setw(15) << "Speedup" << endl;
    cout << "--------------------------------------------------------------------------------\n";
