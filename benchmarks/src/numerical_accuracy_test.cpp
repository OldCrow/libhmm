...
void testNumericalAccuracy() {
    ...
    try {
        ...
        double fb_log_from_prob =
            (fb_probability > 0.0) ? log(fb_probability) : -std::numeric_limits<double>::infinity();

        cout << "  ForwardBackward log-likelihood: " << scientific << setprecision(10)
             << fb_log_likelihood << endl;
        cout << "  ForwardBackward probability: " << scientific << setprecision(10)
             << fb_probability << endl;
        cout << "  ForwardBackward log(probability): " << scientific << setprecision(10)
             << fb_log_from_prob << endl;
        ...
        cout << "  Viterbi log-likelihood: " << scientific << setprecision(10)
             << viterbi_log_likelihood << endl;
    ...
    try {
        ...
        cout << "HMMLib likelihood: " << scientific << setprecision(10) << hmmlib_likelihood
             << endl;
