        ...
        try {
            ...
            if (sequence_length == 100) {
                const fs::path debug_path =
                    debug_output_dir_ /
                    ("debug_stochhmm_model_" + sanitizeFileComponent(problem.name) + ".hmm");
            ...
            if (sequence_length == 100) {
                cout << "[DEBUG] StochHMM using simple algorithms (basic model: "
                     << (hmm.isBasic() ? "true" : "false") << ")" << endl;
            }
...
void printComparisonResults(const vector<BenchmarkResults> &results) {
    ...
    cout << left << setw(12) << "Library" << setw(25) << "Problem" << setw(8) << "Length"
    ...
    for (const auto &result : results) {
        ...
        cout << left << setw(12) << result.library_name << setw(25) << result.problem_name
             << setw(8) << result.sequence_length << setw(15) << fixed << setprecision(3)
...
void printPerformanceComparison(const vector<BenchmarkResults> &results) {
    ...
    cout << left << setw(25) << "Problem" << setw(10) << "Length" << setw(16) << "libhmm (ms)"
         << setw(16) << "StochHMM (ms)" << setw(12) << "Speedup" << endl;
    cout << string(80, '-') << endl;
        ...
        if (group.second.size() >= 2) {
            ...
            if (libhmm_time > 0 && stochhmm_time > 0) {
                ...
                cout << left << setw(25) << problem_name << setw(10) << length << setw(16) << fixed
                     << setprecision(3) << libhmm_time << setw(16) << stochhmm_time
