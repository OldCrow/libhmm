...
void SIMDOps::vector_add(const double *a, const double *b, double *result,
...
void SIMDOps::vector_multiply(const double *a, const double *b, double *result,
                              std::size_t size) noexcept {
#ifdef LIBHMM_HAS_AVX
    if (simd_available() && size >= DOUBLE_SIMD_WIDTH) {
...
void SIMDOps::scalar_multiply(const double *a, double scalar, double *result,
                              std::size_t size) noexcept {
#ifdef LIBHMM_HAS_AVX
    if (simd_available() && size >= DOUBLE_SIMD_WIDTH) {
...
void SIMDOps::matrix_vector_multiply(const double *matrix, const double *vector, double *result,
...
void SIMDOps::vector_add_fallback(const double *a, const double *b, double *result,
                                  std::size_t size) noexcept {
    for (std::size_t i = 0; i < size; ++i) {
        result[i] = a[i] + b[i];
    }
...
void SIMDOps::vector_multiply_fallback(const double *a, const double *b, double *result,
                                       std::size_t size) noexcept {
    for (std::size_t i = 0; i < size; ++i) {
        result[i] = a[i] * b[i];
    }
...
void SIMDOps::scalar_multiply_fallback(const double *a, double scalar, double *result,
                                       std::size_t size) noexcept {
    for (std::size_t i = 0; i < size; ++i) {
        result[i] = a[i] * scalar;
    }
...
void SIMDOps::vector_add_avx(const double *a, const double *b, double *result,
                             std::size_t size) noexcept {
    std::size_t simd_end = (size / DOUBLE_SIMD_WIDTH) * DOUBLE_SIMD_WIDTH;
...
void SIMDOps::vector_multiply_avx(const double *a, const double *b, double *result,
                                  std::size_t size) noexcept {
    std::size_t simd_end = (size / DOUBLE_SIMD_WIDTH) * DOUBLE_SIMD_WIDTH;
...
void SIMDOps::scalar_multiply_avx(const double *a, double scalar, double *result,
                                  std::size_t size) noexcept {
...
void SIMDOps::vector_add_sse2(const double *a, const double *b, double *result,
                              std::size_t size) noexcept {
    std::size_t simd_end = (size / 2) * 2;
...
void SIMDOps::vector_multiply_sse2(const double *a, const double *b, double *result,
                                   std::size_t size) noexcept {
    std::size_t simd_end = (size / 2) * 2;
...
void SIMDOps::scalar_multiply_sse2(const double *a, double scalar, double *result,
                                   std::size_t size) noexcept {
...
void SIMDOps::vector_add_neon(const double *a, const double *b, double *result,
                              std::size_t size) noexcept {
    std::size_t simd_end = (size / 2) * 2;
...
void SIMDOps::vector_multiply_neon(const double *a, const double *b, double *result,
                                   std::size_t size) noexcept {
    std::size_t simd_end = (size / 2) * 2;
...
void SIMDOps::scalar_multiply_neon(const double *a, double scalar, double *result,
                                   std::size_t size) noexcept {
