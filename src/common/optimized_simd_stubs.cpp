...
template <>
std::pair<double, OptimizedVector<double>::size_type>
OptimizedVector<double>::max_element_simd() const {
    return max_element_serial();
}

template <>
std::pair<double, OptimizedVector<double>::size_type>
OptimizedVector<double>::min_element_simd() const {
...
template <>
void OptimizedMatrix<double>::multiply_vector_simd(const OptimizedVector<double> &vec,
                                                   OptimizedVector<double> &result) const {
...
template <>
std::pair<float, OptimizedVector<float>::size_type>
OptimizedVector<float>::max_element_simd() const {
    return max_element_serial();
}

template <>
std::pair<float, OptimizedVector<float>::size_type>
OptimizedVector<float>::min_element_simd() const {
    return min_element_serial();
}
...
template <>
void OptimizedMatrix<float>::multiply_vector_simd(const OptimizedVector<float> &vec,
                                                  OptimizedVector<float> &result) const {
    multiply_vector_serial(vec, result);
}
