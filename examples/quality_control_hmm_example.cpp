...
int main() {
    ...
    Matrix trans(2, 2);
    trans(0, 0) = 0.92;
    trans(0, 1) = 0.08; // In control tends to stay in control
    trans(1, 0) = 0.35;
    trans(1, 1) = 0.65; // Out of control can persist
    hmm->setTrans(trans);
    ...
    std::cout << "P(1 defect | In control)     = " << hmm->getDistribution(0).getProbability(1)
              << std::endl;
    std::cout << "P(1 defect | Out of control) = " << hmm->getDistribution(1).getProbability(1)
              << std::endl;
    std::cout << "P(5 defects | In control)    = " << hmm->getDistribution(0).getProbability(5)
              << std::endl;
    std::cout << "P(5 defects | Out of control) = " << hmm->getDistribution(1).getProbability(5)
              << std::endl;
    std::cout << "P(15 defects | In control)   = " << hmm->getDistribution(0).getProbability(15)
              << std::endl;
    std::cout << "P(15 defects | Out of control) = " << hmm->getDistribution(1).getProbability(15)
              << std::endl;
    std::cout << std::endl;
    ...
    trainHmm->setDistribution(0,
                              std::make_unique<BinomialDistribution>(100, 0.05)); // Initial guess
    trainHmm->setDistribution(1,
                              std::make_unique<BinomialDistribution>(100, 0.15)); // Initial guess
