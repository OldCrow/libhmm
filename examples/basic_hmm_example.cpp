...
int main() {
    ...
    }
    {
        ...
        for (const ObservationSet *obs : {&set1, &set2, &set3}) {
            ...
            std::cout << "  Observations: " << *obs << "  P(O|\u03bb)=" << fbc.probability()
...

    {
        ...
        std::cout << gd.getProbability(0) << "\t" << gd.getProbability(1) << "\t"
        ...
        std::cout << "p( 0 ) \t\t p( 1 ) \t\t p( 2 ) " << std::endl;
        std::cout << gamdist.getProbability(0) << "\t\t" << gamdist.getProbability(1) << "\t\t"
        ...
        std::cout << "p( 0 ) \t\t p( 1 ) \t\t p( 2 ) " << std::endl;
        std::cout << logndist.getProbability(0) << "\t\t" << logndist.getProbability(1) << "\t\t"
        ...
        std::cout << "p( 0 ) \t\t p( 1 ) \t\t p( 2 ) " << std::endl;
        std::cout << edist.getProbability(0) << "\t\t" << edist.getProbability(1) << "\t\t"
        ...
        std::cout << poissonDist.getProbability(0) << "\t\t" << poissonDist.getProbability(1)
