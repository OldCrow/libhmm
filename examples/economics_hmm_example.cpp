...
int main() {
    ...
    customerTrans(0, 0) = 0.80;
    customerTrans(0, 1) = 0.20; // Low activity can shift to high
    customerTrans(1, 0) = 0.30;
    customerTrans(1, 1) = 0.70; // High activity tends to persist
    ...
    customerHmm->setDistribution(
        0, std::make_unique<NegativeBinomialDistribution>(2, 0.3)); // Low activity
    customerHmm->setDistribution(
        1, std::make_unique<NegativeBinomialDistribution>(8, 0.4)); // High activity
    ...
    economicTrans(0, 0) = 0.95;
    economicTrans(0, 1) = 0.05; // Normal economy is stable
    economicTrans(1, 0) = 0.15;
    economicTrans(1, 1) = 0.85; // Crisis can persist
    ...
    trainHmm->setDistribution(
        0, std::make_unique<NegativeBinomialDistribution>(3, 0.4)); // Initial guess
    trainHmm->setDistribution(
        1, std::make_unique<NegativeBinomialDistribution>(6, 0.5)); // Initial guess
