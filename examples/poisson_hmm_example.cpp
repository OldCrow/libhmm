...
int main() {
    ...
    std::cout << "P(15 requests | Normal state) = " << hmm->getDistribution(0).getProbability(15)
              << std::endl;
    std::cout << "P(15 requests | High state) = " << hmm->getDistribution(1).getProbability(15)
              << std::endl;
    std::cout << "P(45 requests | Normal state) = " << hmm->getDistribution(0).getProbability(45)
              << std::endl;
    std::cout << "P(45 requests | High state) = " << hmm->getDistribution(1).getProbability(45)
              << std::endl;
    std::cout << std::endl;
