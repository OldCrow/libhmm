...
int main() {
    ...
    std::cout << "P(lifetime=100 | Normal)   = " << hmm->getDistribution(0).getProbability(100)
              << std::endl;
    std::cout << "P(lifetime=100 | Degraded) = " << hmm->getDistribution(1).getProbability(100)
              << std::endl;
    std::cout << "P(lifetime=100 | Critical) = " << hmm->getDistribution(2).getProbability(100)
              << std::endl;
    std::cout << "P(lifetime=500 | Normal)   = " << hmm->getDistribution(0).getProbability(500)
              << std::endl;
    std::cout << "P(lifetime=500 | Degraded) = " << hmm->getDistribution(1).getProbability(500)
              << std::endl;
    std::cout << "P(lifetime=500 | Critical) = " << hmm->getDistribution(2).getProbability(500)
              << std::endl;
    std::cout << std::endl;
    ...
    failureTrans(0, 0) = 0.85;
    failureTrans(0, 1) = 0.15; // Normal -> High failure
    failureTrans(1, 0) = 0.40;
    failureTrans(1, 1) = 0.60; // High -> Normal failure
    ...
    std::cout << "P(time=50 | Low rate)  = " << failureHmm->getDistribution(0).getProbability(50)
              << std::endl;
    std::cout << "P(time=50 | High rate) = " << failureHmm->getDistribution(1).getProbability(50)
              << std::endl;
    std::cout << "P(time=200 | Low rate)  = " << failureHmm->getDistribution(0).getProbability(200)
              << std::endl;
    std::cout << "P(time=200 | High rate) = " << failureHmm->getDistribution(1).getProbability(200)
              << std::endl;
    std::cout << std::endl;
    ...
    trainHmm->setDistribution(0,
                              std::make_unique<WeibullDistribution>(2.0, 800.0)); // Initial guess
    trainHmm->setDistribution(1,
                              std::make_unique<WeibullDistribution>(1.5, 400.0)); // Initial guess
    trainHmm->setDistribution(2,
                              std::make_unique<WeibullDistribution>(1.0, 150.0)); // Initial guess
