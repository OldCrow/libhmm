...
int main() {
    ...
    const std::vector<Config> configs = {
        {2, 200}, {4, 500}, {8, 1000}, {16, 1000}, {32, 500}, {64, 200}, {128, 100},
    };
    ...
    std::cout << std::setw(5) << "N" << std::setw(7) << "T" << std::setw(12) << "FB (ms)"
              << std::setw(16) << "FB (ss/ms)" << std::setw(12) << "V (ms)" << std::setw(16)
              << "V (ss/ms)\n";
    ...
    for (const auto &cfg : configs) {
        ...
        std::cout << std::setw(5) << cfg.N << std::setw(7) << cfg.T << std::setw(10) << fb_ms
                  << " ms" << std::setw(12) << static_cast<long long>(state_steps / fb_ms)
                  << " ss/ms" << std::setw(10) << vt_ms << " ms" << std::setw(12)
                  << static_cast<long long>(state_steps / vt_ms) << " ss/ms\n";
    }
