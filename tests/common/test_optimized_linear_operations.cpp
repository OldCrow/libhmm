...
void test_optimized_matrix3d_operations() {
    ...
    std::cout << "Slice 0 access: slice0[1][2] = " << slice0[1][2] << " (should be 12)\n";
    std::cout << "Slice 0 function access: slice0(1,2) = " << slice0(1, 2) << " (should be 12)\n";
    ...
    mat3d_copy *= 2.0;
    std::cout << "After scalar multiplication by 2, mat3d_copy(0,1,2) = " << mat3d_copy(0, 1, 2)
              << " (should be 24)\n";

    mat3d += mat3d_copy;
    std::cout << "After adding doubled matrix, mat3d(0,1,2) = " << mat3d(0, 1, 2)
              << " (should be 36)\n";
    ...
    std::cout << "Large matrix filled with parallel operation: " << large_mat3d(25, 25, 25)
              << " (should be 3.14)\n";
...
void test_performance_comparison() {
    ...
    std::cout << "Matrix size: " << mat_rows << "x" << mat_cols << " (" << mat_rows * mat_cols
              << " elements)\n\n";
...
void test_conversion_constructors() {
    ...
    std::cout << "\nBasic matrix3D dimensions: " << basic_mat3d.getXDimensionSize() << "x"
              << basic_mat3d.getYDimensionSize() << "x" << basic_mat3d.getZDimensionSize() << "\n";
    std::cout << "Optimized matrix3D dimensions: " << opt_mat3d.getXDimensionSize() << "x"
              << opt_mat3d.getYDimensionSize() << "x" << opt_mat3d.getZDimensionSize() << "\n";
    ...
    for (size_t i = 0; i < basic_mat3d.getXDimensionSize(); ++i) {
        for (size_t j = 0; j < basic_mat3d.getYDimensionSize(); ++j) {
            ...
            if (!mat3d_data_matches)
                break;
        }
        if (!mat3d_data_matches)
            break;
    }
    std::cout << "Matrix3D conversion data integrity: "
              << (mat3d_data_matches ? "✅ PASS" : "❌ FAIL") << "\n";
