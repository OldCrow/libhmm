...
private:
    ...
    static double accum_sequence(const Hmm &hmm, const ObservationSet &obs,
    ...
    static void normalize_and_commit(Hmm &hmm, std::size_t N,
                                      Vector &pi, Matrix &trans) noexcept;
