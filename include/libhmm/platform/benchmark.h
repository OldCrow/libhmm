...
public:
    ...
    explicit Benchmark(bool enableWarmup = true, std::size_t defaultIterations = 100,
...
#define LIBHMM_BENCHMARK_SIMPLE(name, func) benchmark.addTest(name, func)

#define LIBHMM_BENCHMARK_WITH_SETUP(name, func, setup, teardown)                                   \
    benchmark.addTest(name, func, 0, 1.0, setup, teardown)

#define LIBHMM_BENCHMARK_ITERATIONS(name, func, iters) benchmark.addTest(name, func, iters)
...
public:
    ...
    static std::vector<ObservationSet> createTestSequences(std::size_t minLength,
                                                           std::size_t maxLength,
                                                           std::size_t numSequences,
    ...
    static std::vector<std::unique_ptr<Hmm>>
    createTestHmms(std::size_t minStates, std::size_t maxStates, std::size_t numSymbols);
    ...
    static void benchmarkForwardBackward(Hmm *hmm, const ObservationSet &observations,
                                         Benchmark &benchmark);
    ...
    /// @param observations Test observations
    /// @param benchmark Benchmark object to add tests to
    static void benchmarkViterbi(Hmm *hmm, const ObservationSet &observations,
                                 Benchmark &benchmark);
    ...
    /// @param benchmark Benchmark object to add tests to
    static void benchmarkTraining(Hmm *hmm, const ObservationLists &observationLists,
                                  Benchmark &benchmark);
};
