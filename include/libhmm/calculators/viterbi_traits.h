...
/// Viterbi calculator performance characteristics
...
/// Viterbi calculator type enumeration
enum class CalculatorType {
    STANDARD,           ///< Standard Viterbi calculator (unscaled)
    SCALED_SIMD,       ///< Scaled SIMD-optimized Viterbi calculator (scaling + SIMD + fallback)
    LOG_SIMD,          ///< Log-space SIMD-optimized Viterbi calculator (log-space + SIMD + fallback)
...
/// RAII helper for automatic Viterbi calculator selection
...
public:
    ...
    /// Decode optimal state sequence using selected calculator
    /// @return Optimal state sequence
    StateSequence decode();
    
    /// Get log probability of optimal path
    /// @return Log probability of the optimal state sequence
    double getLogProbability() const;
    
    /// Get the optimal state sequence
    /// @return The decoded state sequence
    StateSequence getStateSequence() const;
};
